...
Answer: Authorization (being mindful not to use British spelling, which is bound to happen at least a few times)
...
```js
//having set the key for the jwt in local storage to 'token'
